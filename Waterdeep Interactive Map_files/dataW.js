var drawWidth = 3560, drawHeight = 7256;
var image = "waterdeep-3560-7256.jpg", imageMob = "waterdeep-1780-3628.jpg", mini = "smallW.jpg";
var lineFocus = 12; var dotWidth = 14, dotTrait = 4, zoomPoint=7, zoomCelPoint=9, zoomMax=11, zoomCelMax=11;
var carte = "W", factorKm = 1017;
var bilang = 0;
...
function guildToName(guild) {
	...
	if (lowerCase == "no one" || lowerCase == "none") return "None";
	if (lowerCase == "carleton" || lowerCase == "carleton u" || lowerCase == "carleton university" || lowerCase == "carlstown" || lowerCase == "carlstown blasting company") return "Carlstown Blasting Company (Carleton)";
	if (lowerCase == "laurier" || lowerCase == "laurier u" || lowerCase == "laurier university" || lowerCase == "laureates" || lowerCase == "the silverware laureates") return "The Silverware Laureates (Laurier)";
	if (lowerCase == "western" || lowerCase == "western u" || lowerCase == "western university" || lowerCase == "westernreach" || lowerCase == "the riders of the westernreach") return "The Riders of the Westernreach (Western)";
...
var zones = [
	{
	 	name: "Field Ward",
		txt: `<p>Newly built and though not an official ward of the city - the Watch doesn't patrol this area -, Field Ward is home to folk of all walks of life who lacked coin enough to hire lodgings or own buildings in old Waterdeep. It is a slum in some places, and a struggling middle-class area in others. The Ward is a noisy, lively area that's home to poor elves, half-bloods of all sorts, and dwarves who are determined to get the respect they are sure they deserve.</p><p><strong>Controlling Guild</strong>: ${owningGuildOf("Field Ward")}</p>`,
		couleur: guildToColour(owningGuildOf("Field Ward")),
		owningGuild: owningGuildOf("Field Ward"),
		bord: "",
		path: "M 738.9,246.7 790.7,176.4 861.1,185.6 948.1,194.9 1085,219 1243,263.4 1404,315.3 1548,369 1700,407.9 1830,446.7 1974,476.4 2122,539.3 2193,567.1 2350,631.9 2456,687.5 2587,780.1 2687,861.6 2781,961.6 2950,1126 2985,1173 2974,1254 2969,1271 2985,1319 2991,1352 2970,1380 2980,1400 2957,1452 2952,1497 2961,1539 2956,1621 2972,1678 2967,1689 2978,1732 2970,1784 2954,1825 2957,1858 2965,1875 2950,1913 2941,1993 2930,1723 2893,1532 2854,1358 2769,1200 2722,1163 2559,1080 2389,1021 2220,935.6 2109,907.9 2048,909.7 1931,881.9 1754,811.6 1583,756 1404,693 1243,596.7 1131,491.2 1046,370.8 C 1046,370.8 972.2,374.5 964.8,374.5 957.4,374.5 933.3,385.6 933.3,385.6 L 813,465.3 731.5,259.7 Z"
	},
	{
	 	name: "Castle Ward",
		txt: `<p>Castle Ward lies in the heart of Waterdeep, wrapping around the eastern slopes of Mount Waterdeep. This ward is home to Castle Waterdeep, Piergeiron's Palace and many city's administrative buildings. Ward of wealthy or influential people who can't count themselves among the nobility.</p><p><strong>Controlling Guild</strong>: ${owningGuildOf("Castle Ward")}</p><p><strong>Ward's colors</strong>: blue and purple</p><p><strong>Mascot</strong>: griffon</p>`,
		couleur: guildToColour(owningGuildOf("Castle Ward")),
		owningGuild: owningGuildOf("Castle Ward"),
		bord: "",
		path: "M 2097,2825 2126,3157 2163,3555 2179,4048 2162,4074 2149,4111 2137,4145 2142,4161 2168,4180 2214,4186 2238,4193 2238,4212 2239,4272 2222,4415 2201,4482 2201,4550 2203,4677 2080,4677 2077,4621 2084,4593 C 2084,4593 2084,4580 2074,4578 2064,4577 2034,4593 2034,4593 L 2019,4570 1983,4553 1935,4549 1836,4553 1781,4560 1760,4553 1678,4559 1602,4569 1490,4570 1455,4576 1373,4576 1344,4590 1306,4638 1289,4660 1279,4690 1284,4727 1306,4830 1317,4867 1328,4907 C 1328,4907 1326,4933 1322,4932 1318,4931 1296,4927 1296,4927 L 1295,5056 1264,5057 1268,4982 C 1260,4980 1193,4994 1193,4994 L 1180,4985 1177,4963 1186,4956 1261,4943 1255,4897 1119,4925 1106,5018 1102,5023 C 1102,5023 1088,5028 1086,5024 1084,5020 1078,5013 1078,5013 1078,5013 1091,4933 1086,4934 1081,4935 999.5,4960 999.5,4960 L 974.7,4963 901.3,4970 907.2,5030 885.4,5029 881.4,4973 833.8,4961 C 833.8,4961 838.7,5047 832.8,5046 826.8,5044 810,5043 810,5043 L 811.9,4961 C 811.9,4961 782.2,4956 778.2,4955 774.2,4954 767.3,4956 767.3,4956 L 750.4,4948 734.5,4955 718.6,4949 710.7,5077 689.8,5077 696.8,4946 686.9,4919 691.2,4914 707,4896 717.5,4871 C 717.5,4871 738.5,4841 745.1,4838 751.7,4835 766.1,4808 766.1,4808 L 764.8,4784 C 764.8,4784 784.5,4762 793.7,4758 802.9,4754 818.7,4724 818.7,4724 L 818.7,4704 809.5,4676 789.8,4654 804.2,4633 816.1,4633 826.6,4617 827.9,4609 842.4,4600 867.3,4599 C 867.3,4599 883.1,4576 888.4,4573 893.6,4569 914.6,4561 914.6,4561 L 943.5,4559 972.5,4567 C 972.5,4567 969.8,4573 968.5,4578 967.2,4583 980.3,4586 980.3,4586 L 1003,4569 1020,4565 1046,4552 1091,4548 1113,4545 1134,4527 1183,4517 1188,4498 1209,4484 1233,4486 1262,4462 C 1262,4462 1268,4467 1273,4469 1279,4470 1288,4454 1288,4454 L 1306,4453 C 1306,4453 1325,4465 1330,4467 1335,4470 1363,4471 1363,4471 L 1392,4442 1394,4415 1376,4383 1367,4358 1371,4329 1388,4299 1414,4276 1434,4272 1456,4283 1477,4283 1499,4279 1510,4289 C 1510,4289 1536,4295 1547,4295 1557,4295 1556,4312 1556,4312 L 1564,4354 C 1564,4354 1576,4356 1590,4356 1605,4356 1599,4337 1599,4337 1599,4337 1619,4333 1626,4332 1632,4331 1647,4343 1647,4343 L 1656,4361 1681,4361 1690,4373 1686,4387 1703,4402 1725,4399 1737,4381 1770,4364 1775,4385 1779,4400 1800,4406 1817,4396 1837,4415 1846,4403 1844,4395 1878,4369 1892,4366 1887,4324 1900,4298 1886,4279 1887,4248 1894,4232 1886,4219 1867,4218 C 1867,4218 1845,4202 1842,4197 1840,4191 1842,4181 1842,4181 1842,4181 1819,4173 1814,4170 1808,4168 1804,4185 1800,4191 1796,4198 1745,4215 1745,4215 L 1727,4207 1703,4218 1678,4203 1637,4174 1581,4147 1528,4143 C 1528,4143 1488,4159 1480,4159 1472,4159 1453,4152 1453,4152 L 1393,4140 1310,4122 1290,4123 1264,4119 1241,4126 1187,4126 1160,4102 1163,4093 1142,4064 1118,4048 1087,4027 1083,4011 1067,3979 1067,3972 1057,3959 1058,3938 1034,3908 1028,3887 1007,3876 993.5,3852 989.5,3834 990.9,3801 977.7,3795 972.5,3772 1000,3728 1001,3713 984.3,3679 964.6,3638 969.8,3601 C 969.8,3601 980.3,3561 981.7,3555 983,3550 993.5,3503 993.5,3503 L 1017,3459 1051,3428 C 1051,3428 1051,3408 1062,3386 1072,3364 1061,3348 1061,3348 L 1067,3337 1066,3308 1078,3251 1089,3191 1087,3185 1093,3139 1080,3124 1083,3090 1063,3034 1049,3001 1017,2968 981.7,2960 942.2,2943 C 942.2,2943 914.6,2922 909.4,2921 904.1,2919 889.7,2893 889.7,2893 L 881.8,2867 881.8,2830 873.9,2791 864.7,2780 854.2,2768 834.5,2722 814.8,2712 792.4,2678 787.2,2620 771.4,2599 730.7,2563 728,2544 724.1,2540 724.1,2521 705.7,2504 661,2487 638.7,2462 609.8,2444 584.8,2449 459.9,2431 400,2359 426.8,2335 507,2325 726.8,2318 1196,2325 1303,2311 1777,2321 1774,2585 1921,2582 1993,2592 2091,2659 2093,2753 Z"
	},
	{
		name: "Dock Ward",
		txt: `<p>Waterdeep's most notorious and colorful ward is also the oldest. Traveler's tales portray it as a lawless, brawling place of drunks, smugglers, and roaming monsters, which is not all that far from the truth. The bustling harbor scene and its attendant activities dominate this ward. Businesses and warehouses that depend on the city's newly restored harbor are located here.</p><p><strong>Controlling Guild</strong>: ${owningGuildOf("Dock Ward")}</p><p><strong>Ward's colors</strong>: burgundy and orange</p><p><strong>Mascot</strong>: swordfish</p>`,
		couleur: guildToColour(owningGuildOf("Dock Ward")),
		owningGuild: owningGuildOf("Dock Ward"),
		bord: "",
	...
	{
		name: "Trades Ward",
		txt: `<p>Given over almost entirely to commerce, Trades Ward lacks the feeling of community found in the more residential wards, but retains the hustle and bustle of a marketplace throughout the day and night.</p><p><strong>Controlling Guild</strong>: ${owningGuildOf("Trades Ward")}</p><p><strong>Ward's colors</strong>: green and purple</p><p><strong>Mascot</strong>: mimic</p>`,
		couleur: guildToColour(owningGuildOf("Trades Ward")),
		owningGuild: owningGuildOf("Trades Ward"),
		bord: "",
	...
	},
	{
		...
		txt: `<p>This walled enclosure on the eastern edge of Trades Ward is the general cemetery for the City of Splendors. Many citizens visit the City of the Dead's parklike green lawns and white marble tombs during the day, for it is one of the few places dominated by greenery that the citizens of Waterdeep can share within the city walls.</p><p><strong>Controlling Guild</strong>: ${owningGuildOf("City of the Dead")}</p>`,
		couleur: guildToColour(owningGuildOf("City of the Dead")),
		owningGuild: owningGuildOf("City of the Dead"),
...
{ name:"Guard Barracks #3", color:"#58ACFA", x:2802, y:6188, txt:"<p>City building</p>", ref:"D56"},
...
{ name:"The Quaffing Quaggoth", color:"#FF0000", x:1263, y:4672, txt:"<p>Tavern. A favorite among sailors, merchants, and young nobles, this dwarven owned and operated establishment is known for its own specialty brew – the Quaggoth, a thick house-brewed stout mixed with a shot of a house secret liquor.</p>", ref:"C53"},
...
{ name:"Dauntlyn’s Doors", color:"#FF0000", x:2022, y:3184, txt:"<p>Luxury Inn</p>", ref:""},
...
{ name:"House of the Moon", color:"#FFFF00", x:766, y:1842, txt:"<p>Temple of Selûne. The tallest tower of any temple in the city.</p>", ref:"$56"},
...
{ name:"Starry Cradles orphanage", color:"#FFFF00", x:1434, y:4600, txt:"<p>The Starry Cradles orphanage is a Dock Ward orphanage run by Matron Griselda Hoppletun, a halfling care-taker, and funded by the House of the Moon and the Selûnite clergy thereof.</p>", ref:""},
...
{ name:"The Dancing Haven", color:"#FFFF00", x:2490, y:1108, txt:"<p>The Dancing Haven is a small tree grove, planted and grown within an abandoned, roofless building in the Northern Ward of Waterdeep. It is used as a base of operations for the followers of Eilistraee in the city.</p>"},

{ name:"GROUP", color:"#2eb82e", x:0, y:0, txt:"Guildhalls"},
{ name:"The House of Crystal", color:"#2eb82e", x:1886, y:2510, txt:"<p>Guildhall. Guild of Glassblowers, Glaziers, & Speculum-makers.</p>", ref:"N46"},
...
{ name:"Aurota's Realms Shop, Street of Tusks Catalogue Counter", color:"#FF00FF", x:2283, y:4027, txt:"<p>Business</p>", ref:"T16"},
...
{ name:"Serpentir Books & Folios", color:"#FF00FF", x:2359, y:4840, txt:"<p>Business</p>", ref:"D10"},
{ name:"Lanternmaker Zorth Ulmaril", color:"#FF00FF", x:2096, y:5261, txt:"<p>Business</p>", ref:"D16"},
{ name:"Aurora's Realms Shop, Slut Street Catalogue Counter", color:"#FF00FF", x:2408, y:5338, txt:"<p>Business</p>", ref:"D24"},
...
{ name:"GROUP", color:"#000066", x:0, y:0, txt:"Warehouses"},
...
{ name:"GROUP", color:"#F4900A", x:0, y:0, txt:"Noble villas"},
...
{ name:"Eltorchul Villa", color:"#F4900A", x:1205, y:1227, txt:"<p>Noble villa.</p>", ref:"$22"},
...
{ name:"Ilvastarr Villa", color:"#FF0001", x:2870, y:23410, txt:"<p>Noble villa.</p>", ref:"N53"},
...
{ name:"Ulbrinter Villa", color:"#F4900A", x:2350, y:1699, txt:"<p>Noble villa.</p>", ref:"N18"},
{ name:"Urmbrusk Villa", color:"#F4900A", x:902, y:1695, txt:"<p>Noble villa of House Urmbrusk, who made their wealth on money lending and land-owning and rose to political power in Waterdeep.</p>", ref:""},
...
{ name:"Silmerhelve Villa", color:"#F4900A", x:2036, y:1344, txt:"<p>Silmerhelve is one of the older noble houses; traditionally their trade and business interest include guardianship, warrior-training and pandering. The Silmerhelve's history seems almost charmed in comparison to so many of their fellows. The Wailing Years seem to have affected them almost not at all, with their businesses booming. Of course, the fact that their essential identity is centered around the idea of protecting folk just means they had more than enough work to keep them secure and prosperous. The wall surrounding Shieldwatch seems prepared for war: it is ten feet tall and of an imposing thickness. It is also dotted with arrow slit openings every ten feet.</p>", ref:"$28"},

{ name:"GROUP", color:"#FFFFFF", x:0, y:0, txt:"Places & Streets"},
{ name:"Heroes' Garden", color:"#FFFFFF", x:1428, y:828, txt:"<p>Waterdeep's only public park outside the City of the Dead is a large, lush area of grass, trees, and ponds once covered by the sprawling school of wizardry known as the Tower of Yintros. A number of statues decorate the area, including large marble statues to the Open Lords Baeron and Lhestyn (in her guise as the Masked Lady). It is often the scene of adventurers retelling tales of their exploits to others and attendant local children. The watch and the local citizenry tend to the park, which means they keep the park free of debris and prevent would-be heroes from carving their names into the trees.</p>", ref:"$70"},
...
{ name:"Court of the White Bull", color:"#FFFFFF", x:2787, y:4209, txt:"<p>Packed-dirt plaza which intermittently acquires the planar trait of wild magic. As a result, no one has ever dared build on the location, making it a natural meeting place and market for caravan owners to peddle their wares from wagons.</p>", ref:""},
{ name:"Virgin's Square", color:"#FFFFFF", x:2333, y:4286, txt:"<p>Market and traditional hiring place for warriors is named for a local legend that virgins were sacrificed to dragons on this spot, long before the founding of Waterdeep.</p>", ref:""},
{ name:"Caravan Court", color:"#FFFFFF", x:2915, y:4713, txt:"<p>Most caravans entering or leaving through the Southern Gate muster or disband in Caravan Court, making it a scene of nonstop activity and chaos.</p>", ref:""},
...
{ name:"Hillock Court", color:"#FFFFFF", x:1936, y:4172, txt:"<p>Court</p>", ref:""},
...
{ name:"Street of Lances", color:"#FFFFFF", x:910, y:501, txt:"<p>Street</p>", ref:"SW"},
{ name:"Trollkill Street", color:"#FFFFFF", x:1583, y:778, txt:"<p>Street</p>", ref:""},
{ name:"Aurenaar Street", color:"#FFFFFF", x:1021, y:751, txt:"<p>Street</p>", ref:""},
{ name:"Aureenar Street", color:"#FFFFFF", x:1021, y:751, txt:"<p>Street</p>", ref:""},
{ name:"Breeze's Cut", color:"#FFFFFF", x:751, y:760, txt:"<p>Street</p>", ref:""},
{ name:"Phastal Street", color:"#FFFFFF", x:1283, y:813, txt:"<p>Street</p>", ref:""},
{ name:"Stormstar's Ride", color:"#FFFFFF", x:1119, y:900, txt:"<p>Street</p>", ref:""},
{ name:"Morningstar Way", color:"#FFFFFF", x:1019, y:790, txt:"<p>Street</p>", ref:""},
{ name:"Kulzar's Alley", color:"#FFFFFF", x:1596, y:866, txt:"<p>Street</p>", ref:""},
{ name:"Rook Alley", color:"#FFFFFF", x:1628, y:895, txt:"<p>Street</p>", ref:""},
{ name:"Heroes's Walk", color:"#FFFFFF", x:1384, y:789, txt:"<p>Street</p>", ref:""},
{ name:"Street of Glances", color:"#FFFFFF", x:1230, y:937, txt:"<p>Street</p>", ref:""},
{ name:"The Fanebar", color:"#FFFFFF", x:1645, y:954, txt:"<p>Street</p>", ref:""},
{ name:"Skull Street", color:"#FFFFFF", x:1557, y:1004, txt:"<p>Street</p>", ref:""},
{ name:"Westwall Street", color:"#FFFFFF", x:554, y:1334, txt:"<p>Street</p>", ref:""},
{ name:"Telchar Lane", color:"#FFFFFF", x:875, y:1007, txt:"<p>Street</p>", ref:""},
{ name:"Staghunter's Way", color:"#FFFFFF", x:1089, y:1057, txt:"<p>Street</p>", ref:""},
{ name:"Wrightstone Street", color:"#FFFFFF", x:1650, y:1092, txt:"<p>Street</p>", ref:""},
{ name:"Bliss Street", color:"#FFFFFF", x:625, y:1150, txt:"<p>Street</p>", ref:""},
{ name:"Gorl Street", color:"#FFFFFF", x:922, y:1136, txt:"<p>Street</p>", ref:""},
{ name:"Lhestyn's Court", color:"#FFFFFF", x:1980, y:1216, txt:"<p>Court</p>", ref:""},
{ name:"Ignorance Alley", color:"#FFFFFF", x:654, y:1240, txt:"<p>Street</p>", ref:""},
{ name:"Ivory Street", color:"#FFFFFF", x:1048, y:1254, txt:"<p>Street</p>", ref:""},
{ name:"Chasso's Trot", color:"#FFFFFF", x:1639, y:1277, txt:"<p>Street</p>", ref:""},
{ name:"Sighing Maiden's Walk", color:"#FFFFFF", x:1009, y:1102, txt:"<p>Street</p>", ref:""},
{ name:"Diamond Street", color:"#FFFFFF", x:1089, y:1725, txt:"<p>Street</p>", ref:""},
{ name:"Grimwald's Way", color:"#FFFFFF", x:668, y:1423, txt:"<p>Street</p>", ref:""},
{ name:"Vondil Street", color:"#FFFFFF", x:1639, y:1475, txt:"<p>Street</p>", ref:""},
{ name:"Shark Street", color:"#FFFFFF", x:742, y:1557, txt:"<p>Street</p>", ref:""},
{ name:"Street of Whispers", color:"#FFFFFF", x:810, y:1689, txt:"<p>Street</p>", ref:""},
{ name:"Flint Street", color:"#FFFFFF", x:1113, y:1359, txt:"<p>Street</p>", ref:""},
{ name:"Seawatch Street", color:"#FFFFFF", x:652, y:1515, txt:"<p>Street</p>", ref:""},
{ name:"Delzorin Street", color:"#FFFFFF", x:1646, y:1690, txt:"<p>Street</p>", ref:""},
{ name:"The Street of the Singing Dolphin", color:"#FFFFFF", x:868, y:1351, txt:"<p>Street</p>", ref:""},
{ name:"Feather Street", color:"#FFFFFF", x:1224, y:1734, txt:"<p>Street</p>", ref:""},
{ name:"Rough Road", color:"#FFFFFF", x:1319, y:1877, txt:"<p>Street</p>", ref:""},
{ name:"Mendever Street", color:"#FFFFFF", x:1413, y:1753, txt:"<p>Street</p>", ref:""},
{ name:"Sul Street", color:"#FFFFFF", x:1586, y:1743, txt:"<p>Street</p>", ref:""},
{ name:"Zarimtar Street", color:"#FFFFFF", x:1395, y:2040, txt:"<p>Street</p>", ref:""},
{ name:"Darselune Street", color:"#FFFFFF", x:1056, y:2068, txt:"<p>Street</p>", ref:""},
{ name:"Courtyard of the Well", color:"#FFFFFF", x:1504, y:2116, txt:"<p>Court</p>", ref:""},
{ name:"The Lions", color:"#FFFFFF", x:639, y:2022, txt:"<p>Street</p>", ref:""},
{ name:"Jelzar's Stride", color:"#FFFFFF", x:637, y:2131, txt:"<p>Street</p>", ref:""},
{ name:"Gulzindar Street", color:"#FFFFFF", x:881, y:2189, txt:"<p>Street</p>", ref:""},
{ name:"Whim Street", color:"#FFFFFF", x:1534, y:2181, txt:"<p>Street</p>", ref:""},
{ name:"Seaeyes March", color:"#FFFFFF", x:434, y:2222, txt:"<p>Street</p>", ref:""},
{ name:"Haltovar Street", color:"#FFFFFF", x:1153, y:2096, txt:"<p>Street</p>", ref:""},
{ name:"Julthoon Street", color:"#FFFFFF", x:948, y:2319, txt:"<p>Street</p>", ref:""},
{ name:"The Sutherlane", color:"#FFFFFF", x:1278, y:2240, txt:"<p>Street</p>", ref:""},
{ name:"Brassfeather Lane", color:"#FFFFFF", x:2207, y:1036, txt:"<p>Street</p>", ref:"NW"},
{ name:"Anteos Lane", color:"#FFFFFF", x:2436, y:1142, txt:"<p>Street</p>", ref:""},
{ name:"Phull Lane", color:"#FFFFFF", x:2546, y:1130, txt:"<p>Street</p>", ref:""},
{ name:"Sashtar Street", color:"#FFFFFF", x:2263, y:1377, txt:"<p>Street</p>", ref:""},
{ name:"Tower March", color:"#FFFFFF", x:2448, y:1430, txt:"<p>Street</p>", ref:""},
{ name:"Black Dog Alley", color:"#FFFFFF", x:2774, y:1377, txt:"<p>Street</p>", ref:""},
{ name:"Immar Street", color:"#FFFFFF", x:2712, y:1443, txt:"<p>Street</p>", ref:""},
{ name:"Windborne Way", color:"#FFFFFF", x:2245, y:1518, txt:"<p>Street</p>", ref:""},
{ name:"Thunderstaff Way", color:"#FFFFFF", x:2168, y:1174, txt:"<p>Street</p>", ref:""},
{ name:"Horn Street", color:"#FFFFFF", x:2636, y:1546, txt:"<p>Street</p>", ref:""},
{ name:"The Trollmarch", color:"#FFFFFF", x:2886, y:1580, txt:"<p>Street</p>", ref:""},
{ name:"Trollskull Alley", color:"#FFFFFF", x:2381, y:1612, txt:"<p>Street</p>", ref:""},
{ name:"Selrin Street", color:"#FFFFFF", x:2839, y:1551, txt:"<p>Street</p>", ref:""},
{ name:"Saerdoun Street", color:"#FFFFFF", x:2578, y:1592, txt:"<p>Street</p>", ref:""},
{ name:"Lion Street", color:"#FFFFFF", x:2812, y:1712, txt:"<p>Street</p>", ref:""},
{ name:"Shield Street", color:"#FFFFFF", x:1774, y:1742, txt:"<p>Street</p>", ref:""},
{ name:"Copper Street", color:"#FFFFFF", x:1924, y:1736, txt:"<p>Street</p>", ref:""},
{ name:"Ilzantil Street", color:"#FFFFFF", x:2183, y:1892, txt:"<p>Street</p>", ref:""},
{ name:"Vhezoar Street", color:"#FFFFFF", x:2316, y:1922, txt:"<p>Street</p>", ref:""},
{ name:"Brondar's Street", color:"#FFFFFF", x:2427, y:1704, txt:"<p>Street</p>", ref:""},
{ name:"Sulmor Street", color:"#FFFFFF", x:2140, y:1956, txt:"<p>Street</p>", ref:""},
{ name:"Hassantyr's Street", color:"#FFFFFF", x:2133, y:2109, txt:"<p>Street</p>", ref:""},
{ name:"Whaelgond Way", color:"#FFFFFF", x:2527, y:1628, txt:"<p>Street</p>", ref:""},
{ name:"Ussilbran Street", color:"#FFFFFF", x:2675, y:2024, txt:"<p>Street</p>", ref:""},
{ name:"Street of the Manticore", color:"#FFFFFF", x:2493, y:2175, txt:"<p>Street</p>", ref:""},
{ name:"Endcliff Lane", color:"#FFFFFF", x:2892, y:2204, txt:"<p>Street</p>", ref:""},
{ name:"Stabbed Sailor Alley", color:"#FFFFFF", x:2445, y:2253, txt:"<p>Street</p>", ref:""},
{ name:"Tarsar's Street", color:"#FFFFFF", x:2665, y:2256, txt:"<p>Street</p>", ref:""},
{ name:"Shattercrock Alley", color:"#FFFFFF", x:2474, y:2318, txt:"<p>Street</p>", ref:""},
{ name:"Manycats Alley", color:"#FFFFFF", x:1877, y:2428, txt:"<p>Infamous Alley. Unsurprisingly, home to many cats the feed on scraps from the surrounding butchers' shops, but it is also known for the many carved stone heads of people and animals that adorn the alley's buildings. Individuals who have walked the alley alone report that some of the heads whispered cryptic messages to them.</p>", ref:""},
{ name:"Tarnath Street", color:"#FFFFFF", x:2300, y:2434, txt:"<p>Street</p>", ref:""},
{ name:"Brahir Street", color:"#FFFFFF", x:2696, y:2487, txt:"<p>Street</p>", ref:""},
{ name:"Gelthoon Street", color:"#FFFFFF", x:2563, y:2624, txt:"<p>Street</p>", ref:""},
{ name:"Trader's Way", color:"#FFFFFF", x:1466, y:2584, txt:"<p>Street</p>", ref:""},
{ name:"Suldown Street", color:"#FFFFFF", x:2465, y:2400, txt:"<p>Street</p>", ref:""},
{ name:"Shando Street", color:"#FFFFFF", x:2434, y:2681, txt:"<p>Street</p>", ref:""},
{ name:"Nindabar Street", color:"#FFFFFF", x:2812, y:2346, txt:"<p>Street</p>", ref:""},
{ name:"Cliffwatch", color:"#FFFFFF", x:3006, y:2474, txt:"<p>Street</p>", ref:""},
{ name:"Undal's Lane", color:"#FFFFFF", x:2287, y:2843, txt:"<p>Street</p>", ref:""},
{ name:"Zendulth Street", color:"#FFFFFF", x:2898, y:2789, txt:"<p>Street</p>", ref:""},
{ name:"Golden Serpent Street", color:"#FFFFFF", x:2766, y:2687, txt:"<p>Street</p>", ref:""},
{ name:"Mhalsymber's Way", color:"#FFFFFF", x:2646, y:2928, txt:"<p>Street</p>", ref:""},
{ name:"Sammarin's Street", color:"#FFFFFF", x:2598, y:2953, txt:"<p>Street</p>", ref:""},
{ name:"The Beaconmarch", color:"#FFFFFF", x:2866, y:2959, txt:"<p>Street</p>", ref:""},
{ name:"Andamaar's Street", color:"#FFFFFF", x:2368, y:2966, txt:"<p>Street</p>", ref:""},
{ name:"Toalar's Lane", color:"#FFFFFF", x:687, y:2424, txt:"<p>Street</p>", ref:"CW"},
{ name:"Gothal Street", color:"#FFFFFF", x:1010, y:2359, txt:"<p>Street</p>", ref:""},
{ name:"Heard Lane", color:"#FFFFFF", x:1503, y:2455, txt:"<p>Street</p>", ref:""},
{ name:"Calamastyr Lane", color:"#FFFFFF", x:968, y:2516, txt:"<p>Street</p>", ref:""},
{ name:"The Cliffride", color:"#FFFFFF", x:530, y:2463, txt:"<p>Street</p>", ref:""},
{ name:"Tchozal's Race", color:"#FFFFFF", x:1168, y:2575, txt:"<p>Street</p>", ref:""},
{ name:"Marlar's Lane", color:"#FFFFFF", x:1215, y:2828, txt:"<p>Street</p>", ref:""},
{ name:"Bazaar Street", color:"#FFFFFF", x:1630, y:2901, txt:"<p>Street</p>", ref:""},
{ name:"Tharleon Street", color:"#FFFFFF", x:1400, y:2918, txt:"<p>Street</p>", ref:""},
{ name:"Swords Street", color:"#FFFFFF", x:1193, y:3198, txt:"<p>Street</p>", ref:""},
{ name:"Keltarn Street", color:"#FFFFFF", x:1409, y:3156, txt:"<p>Street</p>", ref:""},
{ name:"Alnether Street", color:"#FFFFFF", x:1543, y:3083, txt:"<p>Street</p>", ref:""},
{ name:"Cambril's Walk", color:"#FFFFFF", x:1768, y:3212, txt:"<p>Street</p>", ref:""},
{ name:"The Street of Bells", color:"#FFFFFF", x:1995, y:3640, txt:"<p>Street</p>", ref:""},
{ name:"Selduth Street", color:"#FFFFFF", x:1903, y:3340, txt:"<p>Street</p>", ref:""},
{ name:"The Street of the Sword", color:"#FFFFFF", x:1819, y:3287, txt:"<p>Street</p>", ref:""},
{ name:"Buckle Alley", color:"#FFFFFF", x:1937, y:3569, txt:"<p>Street</p>", ref:""},
{ name:"The Street of Silks", color:"#FFFFFF", x:1292, y:3321, txt:"<p>Street</p>", ref:""},
{ name:"The Street of Silver", color:"#FFFFFF", x:1474, y:3436, txt:"<p>Street</p>", ref:""},
{ name:"Warrior's Way", color:"#FFFFFF", x:1668, y:3412, txt:"<p>Street</p>", ref:""},
{ name:"Waterdeep Way", color:"#FFFFFF", x:1990, y:4063, txt:"<p>Street</p>", ref:""},
{ name:"Soothsayer's Way", color:"#FFFFFF", x:2256, y:4415, txt:"<p>Street</p>", ref:""},
{ name:"Coin Alley", color:"#FFFFFF", x:830, y:4790, txt:"<p>Street</p>", ref:""},
{ name:"Lackpurse Lane", color:"#FFFFFF", x:1801, y:4560, txt:"<p>Street</p>", ref:"DW"},
{ name:"Belnimbra's Street", color:"#FFFFFF", x:1666, y:4686, txt:"<p>Street</p>", ref:""},
{ name:"Sail Street", color:"#FFFFFF", x:1266, y:4839, txt:"<p>Street</p>", ref:""},
{ name:"Snail Street", color:"#FFFFFF", x:2219, y:4953, txt:"<p>Street</p>", ref:""},
{ name:"Dock Street", color:"#FFFFFF", x:1716, y:5168, txt:"<p>Street</p>", ref:""},
{ name:"Fish Street", color:"#FFFFFF", x:1860, y:5127, txt:"<p>Street</p>", ref:""},
{ name:"Ship Street", color:"#FFFFFF", x:2028, y:5327, txt:"<p>Street</p>", ref:""},
{ name:"Net Street", color:"#FFFFFF", x:2365, y:5560, txt:"<p>Street</p>", ref:""},
{ name:"River Street", color:"#FFFFFF", x:2854, y:4406, txt:"<p>Street</p>", ref:""},
{ name:"Lamp Street", color:"#FFFFFF", x:2256, y:2959, txt:"<p>Street</p>", ref:"TW"},
{ name:"Irimar's Walk", color:"#FFFFFF", x:2350, y:3190, txt:"<p>Street</p>", ref:""},
{ name:"Spindle Street", color:"#FFFFFF", x:2289, y:3507, txt:"<p>Street</p>", ref:""},
{ name:"The High Road", color:"#FFFFFF", x:2112, y:2971, txt:"<p>Street</p>", ref:""},
{ name:"Fishgut Court", color:"#FFFFFF", x:1659, y:4954, txt:"<p>Court</p>", ref:""},
{ name:"The Way of the Dragon", color:"#FFFFFF", x:2568, y:5396, txt:"<p>Street</p>", ref:"SW"},
{ name:"The Trollyard", color:"#FFFFFF", x:877, y:277, txt:"<p>Court</p>", ref:"FW"},
{ name:"Northyard", color:"#FFFFFF", x:2136, y:663, txt:"<p>Court</p>", ref:""},
{ name:"The Fieldway", color:"#FFFFFF", x:1407, y:519, txt:"<p>Street</p>", ref:""},
{ name:"Nanze Street", color:"#FFFFFF", x:1621, y:448, txt:"<p>Street</p>", ref:""},
{ name:"Burnt Inn Street", color:"#FFFFFF", x:1596, y:690, txt:"<p>Street</p>", ref:""},
{ name:"SaltporkStreet", color:"#FFFFFF", x:1945, y:781, txt:"<p>Street</p>", ref:""},
{ name:"Gawenknife Street", color:"#FFFFFF", x:2577, y:1000, txt:"<p>Street</p>", ref:""},
{ name:"Shanty Lane", color:"#FFFFFF", x:2645, y:942, txt:"<p>Street</p>", ref:""},
{ name:"Chop Street", color:"#FFFFFF", x:2380, y:765, txt:"<p>Street</p>", ref:""},
{ name:"Book Street", color:"#FFFFFF", x:2362, y:4978, txt:"<p>Street</p>", ref:""},
{ name:"Candle Lane", color:"#FFFFFF", x:2424, y:4962, txt:"<p>Street</p>", ref:""},
{ name:"Asmagh's Alley", color:"#FFFFFF", x:1593, y:3575, txt:"<p>Asmagh was an apothecary who would poison and bury patients upright beneath the alley. Upon being discovered as many as eighty bodies were exhumed from the alleys wide flagstones. Though this happened over a century ago, children and some adults hop on one foot when crossing Asmagh's Alley singing a song: <em>Hop for the hollows, hop for the dead, hop on the flagstones, hop on their heads</em>.</p>", ref:""},
{ name:"Ruid's Stroll", color:"#FFFFFF", x:2988, y:4771, txt:"<p>This short avenue is haunted by the hooded ghost of the mage Ruid, whose touch causes deathly chills to those he meets on foggy nights. All attempts to banish or turn the spirit have failed. Those who brave its unearthly approach and allow Ruid to pass through them learn a secret truth about someone or something in their life - if they survive.</p>", ref:""},
{ name:"Three Daggers Alley", color:"#FFFFFF", x:2110, y:4948, txt:"<p>Infamous Alley. This alley suffers from a magical curse that causes three daggers to appear out of thin air and attack passersby. The daggers swoop and fly about, making multiple attempts at murder before vanishing again. This magical effect, the result of a spell cast by a long-dead wizard, has resisted all attempts to dispel it. Some locals boast of how many times they've crossed the alley and lived to tell of it, but the appearance of the daggers is entirely a matter of chance, and unpredictable.</p>", ref:""},
{ name:"Pharra's Alley", color:"#FFFFFF", x:1203, y:1347, txt:"<p>Infamous Alley. This alley is named after the first leader of the House of Wonder, but is more infamous for its Circle of Skulls. This infrequent and unpredictable haunting takes the form of seven floating skulls, which hover in a circle and argue with one another in whispered tones about events in the city. If they are interrupted, their reaction reportedly varies from being helpful to engaging in murderous spell-slinging.</p>", ref:""},
{ name:"Gondwatch Lane", color:"#FFFFFF", x:755, y:1664, txt:"<p>Infamous Alley. This alley serves as the testing ground for inventions considered too dangerous to operate inside the temple. The locals are generally unconcerned about the risks, though, and stand watching while food vendors circulate among them.</p>", ref:""},
{ name:"Brindul Alley", color:"#FFFFFF", x:2822, y:4347, txt:"<p>Infamous Alley. This is the lair of the Hand that Sings, a magical phantasm of a hand with a mouth in its palm. The hand is said to snatch valuables it fancies - especially magical ones - when it encounters them, an to occasionally attack folk in the darkness, strangling them or tripping them into fatal falls. Most often, though, it takes no notice of those who don't bother of follow it, eerily singing fragments of old Sword Coast ballads and love songs as it drifts through the night.</p>", ref:""},
{ name:"Telshambra's Street", color:"#FFFFFF", x:2565, y:4752, txt:"<p>Street</p>", ref:""},
{ name:"The Street of Smiths", color:"#FFFFFF", x:2610, y:4914, txt:"<p>Street</p>", ref:""},
{ name:"The Wagonrace", color:"#FFFFFF", x:2927, y:4512, txt:"<p>Street</p>", ref:""},
{ name:"Sahtyra's Lane", color:"#FFFFFF", x:2805, y:4631, txt:"<p>Street</p>", ref:""},
{ name:"Wall Street", color:"#FFFFFF", x:3004, y:4643, txt:"<p>Street</p>", ref:""},
{ name:"Buckle Street", color:"#FFFFFF", x:2787, y:4753, txt:"<p>Street</p>", ref:""},
{ name:"Rising Ride", color:"#FFFFFF", x:2801, y:4884, txt:"<p>Street</p>", ref:""},
{ name:"Drover's Street", color:"#FFFFFF", x:2760, y:4531, txt:"<p>Street</p>", ref:""},
{ name:"Robin's Way", color:"#FFFFFF", x:2924, y:4886, txt:"<p>Street</p>", ref:""},
{ name:"Shoor Street", color:"#FFFFFF", x:2613, y:4523, txt:"<p>Street</p>", ref:""},
{ name:"Crook Street", color:"#FFFFFF", x:1452, y:4676, txt:"<p>Street</p>", ref:""},
{ name:"Sakiir's Street", color:"#FFFFFF", x:1660, y:4822, txt:"<p>Street</p>", ref:""},
{ name:"Eel Street", color:"#FFFFFF", x:1603, y:4660, txt:"<p>Street</p>", ref:""},
{ name:"Sea Lion Street", color:"#FFFFFF", x:1075, y:4835, txt:"<p>Street</p>", ref:""},
{ name:"Knife's Edge", color:"#FFFFFF", x:1626, y:4500, txt:"<p>Street</p>", ref:""},
{ name:"Tarnished Silver Alley", color:"#FFFFFF", x:1115, y:4719, txt:"<p>Street</p>", ref:""},
{ name:"The Specterwalk", color:"#FFFFFF", x:2981, y:5301, txt:"<p>Street</p>", ref:""},
{ name:"Carter's Way", color:"#FFFFFF", x:2966, y:5431, txt:"<p>Street</p>", ref:""},
{ name:"Tezambril's Street", color:"#FFFFFF", x:2868, y:5178, txt:"<p>Street</p>", ref:""},
{ name:"Olaim's Cut", color:"#FFFFFF", x:2972, y:5209, txt:"<p>Street</p>", ref:""},
{ name:"Coach Street", color:"#FFFFFF", x:2906, y:5460, txt:"<p>Street</p>", ref:""},
{ name:"Elvarren's Lane", color:"#FFFFFF", x:912, y:2608, txt:"<p>Street</p>", ref:""},
{ name:"The Rise", color:"#FFFFFF", x:876, y:2938, txt:"<p>Street</p>", ref:""},
{ name:"Lemontree Alley", color:"#FFFFFF", x:1394, y:3876, txt:"<p>Opening off Shadows Alley north of Cage Street in the first block of buildings east of Piergeiron's Palace, this tiny threelegged passage is crowded with the lemon trees for which it is named. Brought here by a local wizard, whose spells give heat enough to keep them alive, these tropical trees are an unexpected delight. Waterdeep is much too cold for them to survive under normal conditions. Those who are tempted to take fruit from the trees, break a branch off, or just take a swing at one of them, are warned that the wizard, Narthindlar of the Nine Spells, has set a guardian monster on these trees: a bear (a monster zombie) that usually sits quietly under one of the trees.</p><p>If you harm or take from a tree, it rises up and drives you away. Narthindlar has provided benches under the trees, and can sometimes be found sitting on one of them, puffing on a pipe and contemplating life, Faerun, and magic. He smokes tobacco into which cherries have been crushed, and it gives off a delightful odor. Diplomats who need to blow off steam or chat away from prying ears in the palace sometimes find their way here, too.</p>"},
{ name:"The Blue Alley", color:"#FFFFFF", x:1025, y:1227, txt:"<p>Most who enter this alley don't come back.</p>", ref:"$8"},
{ name:"Quill Alley", color:"#FFFFFF", x:2663, y:4086, txt:"<p>Street</p>", ref:""},
{ name:"Elsambul's Lane", color:"#FFFFFF", x:1723, y:3052, txt:"<p>Street</p>"},
{ name:"Coachlamp Lane", color:"#FFFFFF", x:3063, y:5654, txt:"<p>Street</p>"},
{ name:"Aveen Street", color:"#FFFFFF", x:2469, y:2573, txt:"<p>Street</p>"},
...
/*
{ name:"Nurneene's Marvelous Masks", color:"#FF00FF", x:0, y:0, txt:"<p>Business. Clothing.</p>", ref:"C84 ???"},
$46{ name:"Urmbrusk Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s & 3s</p>"},
N2{ name:"Brossfdther Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s & 3s</p>"},
N3{ name:"Anteos Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 1s & 2s</p>"},
N4{ name:"Phull Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 1s & 3s</p>"},
N5{ name:"Snome Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s</p>"},
N6{ name:"Crommor Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s</p>"},
N7{ name:"Piiradost Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, ls & 2s</p>"},
N11{ name:"Hawkwinter Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 3s & 4s</p>"},
N12{ name:"Sultlue Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s</p>"},
N13{ name:"Cragsmere Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s & 3s</p>"},
N14{ name:"Massalan Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 1s & 2s</p>"},
N17{ name:"Lanngolyn Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 1s & 3s</p>"},
N19{ name:"Jardeth Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s</p>"},
N22{ name:"Maerklos Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 1s, 2s, & 4s</p>"},
N23{ name:"Nandar Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s & 3s</p>"},
N24{ name:"Stormweather Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s & 5's</p>"},
N28{ name:"Durinbold Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 3s & 4s</p>"},
N29{ name:"Estelmer Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s & 3s</p>"},
N30{ name:"Tann Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 3s</p>"},
N3f{ name:"Hunabar Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s</p>"},
N36{ name:"Thorp Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 3s</p>"},
N37{ name:"Lathkule Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 3s</p>"},
N38{ name:"Kormallis Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 1s & 2s</p>"},
N42{ name:"Roaringhorn Villa - The High House of Roaririghorn", color:"#FF0001", x:0, y:0, txt:"<p>noble villa</p>"},
N44{ name:"Zun Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 2s & 4s</p>"},
N52{ name:"Hothemer Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 3s</p>"},
N57{ name:"Gost Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 3s & 4s</p>"},
N58{ name:"Helmfast Villa", color:"#FF0001", x:0, y:0, txt:"<p>noble villa, A, 3s</p>"},
N59{ name:"Orlpar Husteem's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 3</p>"},
N63{ name:"Danilo Thann's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, A, 3</p>"},
N64{ name:"Maerik Thaelcloak's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, A, 2</p>"},
N71{ name:"Greenglade Tower", color:"#FF0001", x:0, y:0, txt:"<p>rooming house, A, 5'</p>"},
N74{ name:"Simon Ilzimmer's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, A, 4</p>"},
N75{ name:"Brianne's Tower", color:"#FF0001", x:0, y:0, txt:"<p>residence, A, 6</p>"},
N76{ name:"Firesong Villa", color:"#FF0001", x:0, y:0, txt:"<p>villa, A, 4</p>"},
C2{ name:"Fair Winds", color:"#FF0001", x:0, y:0, txt:"<p>villa, B, 2</p>"},
C28{ name:"Velstrode the Venturer's Row house", color:"#FF0001", x:0, y:0, txt:"<p>house, B, 3</p>"},
C41{ name:"Shy~rhr's House", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 3</p>"},
C42{ name:"Loene the Fighter's House", color:"#FF0001", x:0, y:0, txt:"<p>row house, A, 3</p>"},
C45{ name:"Lady Naneatha Lhaurilstar's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 3</p>"},
C61{ name:"Delzimmer residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 4</p>"},
C62{ name:"Irlingstar residence - Sablehearth", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 4</p>"},
C63{ name:"Syndra Wands' Tower", color:"#FF0001", x:0, y:0, txt:"<p>wizard's domicile, B, 3</p>"},
C71{ name:"Caladorn Cassalanter's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, A, 3</p>"},
C77{ name:"Larissa Neathal's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, A, 2</p>"},
C80{ name:"Tolgar Anuvien's residence", color:"#FF0001", x:0, y:0, txt:"<p>villa, A, 3</p>"},
C82{ name:"Haerun Mhammaster's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, C, 3</p>"},
C83{ name:"Ammathair Hawkfeather's residence", color:"#FF0001", x:0, y:0, txt:"<p>house</p>"},
T5{ name:"Myrmith Splendors' residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 2</p>"},
T6{ name:"Mhair's Tower", color:"#FF0001", x:0, y:0, txt:"<p>wizard's domicile, A, 5"</p>"},
T41{ name:"Scirkhel Wands' residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 3</p>"},
T44{ name:"Blackstone House", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 4</p>"},
T50{ name:"Zeltabbar Iliphar's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 3</p>"},
CD1{ name:"Roads' End", color:"#FF0001", x:0, y:0, txt:"<p>vault, C, i </p>"},
CD2{ name:"The House of the Homeless", color:"#FF0001", x:0, y:0, txt:"<p>tomb, C, 1</p>"},
CD3{ name:"Ahghairon's Statue", color:"#FF0001", x:0, y:0, txt:"<p>tomb, A, 1</p>"},
CD4{ name:"Merchants' Rest", color:"#FF0001", x:0, y:0, txt:"<p>tomb, B, 1</p>"},
CD5{ name:"Warriors' Monument", color:"#FF0001", x:0, y:0, txt:"<p>tomb, B, 1</p>"},
CD6{ name:"Lords' Respite", color:"#FF0001", x:0, y:0, txt:"<p>tomb, A, 1</p>"}, ,
CD7{ name:"The Hall of the Sages", color:"#FF0001", x:0, y:0, txt:"<p>tomb, B, 1</p>"},
CD8{ name:"The Hall of Heroes", color:"#FF0001", x:0, y:0, txt:"<p>tomb, A, 1</p>"},
CD9{ name:"Mariners' Rest", color:"#FF0001", x:0, y:0, txt:"<p>tomb, C, 1</p>"},
CD10{ name:"Deepwinter Vault", color:"#FF0001", x:0, y:0, txt:"<p>tomb, B, 1</p>"},
CD14{ name:"Sultlue Vault", color:"#FF0001", x:0, y:0, txt:"<p>tomb, B, 1</p>"},
D34{ name:"Arnagu~ the Shipwright's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 3</p>"},
D53{ name:"Jemuril the Dwarf's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, C, 2</p>"},
D68{ name:"Gathgaer Milomynt's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, D, 2</p>"},
S10{ name:"Flurmastyr residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, C, 2</p>"},
S30{ name:"Madame Garah's Boarding House", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 2</p>"},
S33{ name:"Rokkek Ingerr's residence", color:"#FF0001", x:0, y:0, txt:"<p>row house, B, 2</p>"},
*/
