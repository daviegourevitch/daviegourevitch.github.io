...
function ownersToColour(ward) {
	...
	console.log("I found that the top uni for " + ward + " was " + curUni)
	return guildToColour(curUni);
}
...
var zones = [
	{
		...
		couleur: ownersToColour("Field Ward"),
		bord: "",
	...
	{
	 	name: "Castle Ward",
		txt: "<p>Castle Ward lies in the heart of Waterdeep, wrapping around the eastern slopes of Mount Waterdeep. This ward is home to Castle Waterdeep, Piergeiron's Palace and many city's administrative buildings. Ward of wealthy or influential people who can't count themselves among the nobility.</p><p><strong>Ward's colors</strong>: blue and purple</p><p><strong>Mascot</strong>: griffon</p>",
		couleur: ownersToColour("Castle Ward"),
		bord: "",
	...
	},
	{
		...
		couleur: ownersToColour("Dock Ward"),
		bord: "",
	...
	},
	{
		...
		couleur: ownersToColour("North Ward"),
		bord: "",
	...
	{
		name: "Sea Ward",
		txt: "<p>Waterdeep's wealthiest ward is notable for the many-spired, grand homes of the nobility, the gleaming edifices of the city's leading temples, and the imposing towers of the city's premier wizards.</p><p><strong>Ward's colors</strong>: blue and gold</p><p><strong>Mascot</strong>: sea lion</p>",
		couleur: ownersToColour("Sea Ward"),
		bord: "",
	...
	},
	{
		...
		couleur: ownersToColour("Southern Ward"),
		bord: "",
	...
	{
		name: "Trades Ward",
		txt: "<p>Given over almost entirely to commerce, Trades Ward lacks the feeling of community found in the more residential wards, but retains the hustle and bustle of a marketplace throughout the day and night.</p><p><strong>Ward's colors</strong>: green and purple</p><p><strong>Mascot</strong>: mimic</p>",
		couleur: ownersToColour("Trades Ward"),
		bord: "",
	...
	},
	{
		...
		couleur: ownersToColour("City of the Dead"),
		bord: "",
